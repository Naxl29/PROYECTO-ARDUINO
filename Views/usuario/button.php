...
<body>
    <div class="mb-3">
            <a href="/PROYECTO-ARDUINO/Views/usuario/button.php" class="boton-back" title="Volver al inicio">
    ...
    <div class="bg-gradient">
        <div class="botones">
            <a href="/PROYECTO-ARDUINO/Views/usuario/button.php" class="boton_2" title="volver al inicio">
